...
public class Main {
	public static void main(String[] args) {
		...
		TaskManager manager = Managers.getSaveHistory();
		 LocalDateTime START_TIME = LocalDateTime.of(2026, 1, 1, 0, 0);

		// Создание
		Task task1 = new Task("Task #1", "Task1 description", NEW, START_TIME, 15);
		Task task2 = new Task("Task #2", "Task2 description", IN_PROGRESS, START_TIME.plusMinutes(15), 15);
		final int taskId1 = manager.addNewTask(task1);
		final int taskId2 = manager.addNewTask(task2);

		Epic epic1 = new Epic("Epic #1", "Epic1 description", START_TIME.plusMinutes(30), 15);
		Epic epic2 = new Epic("Epic #2", "Epic2 description", START_TIME.plusMinutes(45), 15);
		final int epicId1 = manager.addNewEpic(epic1);
		final int epicId2 = manager.addNewEpic(epic2);

		Subtask subtask1 = new Subtask("Subtask #1-1", "Subtask1 description", NEW, epicId1, START_TIME.plusMinutes(60), 15);
		Subtask subtask2 = new Subtask("Subtask #2-1", "Subtask1 description", NEW, epicId1, START_TIME.plusMinutes(75), 15);
		Subtask subtask3 = new Subtask("Subtask #3-2", "Subtask1 description", DONE, epicId2, START_TIME.plusMinutes(90), 15);
